            ...
            <main className="flex-1 p-4 md:p-8 lg:p-10 overflow-y-auto relative h-screen">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <header className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                        ...
                        <div className="bg-white/80 dark:bg-[#0f172a]/80 p-1.5 rounded-xl flex border border-gray-200 dark:border-white/10 backdrop-blur-xl shadow-lg dark:shadow-2xl transition-colors">
                            <button
                                onClick={() => setViewMode("ai")}
                                className={`px-6 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all duration-300 flex items-center gap-2 ${viewMode === "ai"
                            ...
                            <button
                                ...
                                className={`px-6 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all duration-300 flex items-center gap-2 ${viewMode === "search"
                                ...
                                >
                                    ...
                                    <form onSubmit={handleSearch} className="relative max-w-2xl mx-auto group">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full h-16 pl-16 pr-32 rounded-2xl bg-white dark:bg-[#0B0F19] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white text-lg focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600 font-medium shadow-xl dark:shadow-2xl"
                                            />
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        ...
                                        {!isSearching && searchResults.length === 0 && (
                                            <div className="col-span-full flex flex-col items-center justify-center py-20 text-gray-500 dark:text-gray-500 border border-dashed border-gray-300 dark:border-white/10 rounded-3xl bg-white/50 dark:bg-white/5">
...
function SearchResultCard({ user }) {
    ...
    return (
        <motion.div
            ...
            className="bg-white/80 dark:bg-[#0f1629]/60 backdrop-blur-md border border-gray-200 dark:border-white/10 p-6 rounded-2xl transition-all group cursor-pointer shadow-lg dark:shadow-xl hover:shadow-purple-500/10 dark:hover:shadow-purple-900/10"
        >
            <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-gray-900 dark:text-white font-bold text-lg leading-tight group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-colors">{user.fullName}</h3>
            ...
            <div className="space-y-3">
                <div className="flex flex-wrap gap-2 h-16 content-start overflow-hidden">
                    {user.skills?.slice(0, 4).map((s, i) => (
                        <span key={i} className="text-[10px] uppercase font-bold text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/5 px-2 py-1 rounded-md">
                            {s.name}
                        </span>
                    ))}
                ...
                <button onClick={() => navigate(`/user/${user._id}`)} className="w-full py-3 rounded-xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white font-bold text-sm hover:bg-purple-600 hover:text-white hover:border-purple-500 transition-all flex items-center justify-center gap-2 group-hover:shadow-lg cursor-pointer">
